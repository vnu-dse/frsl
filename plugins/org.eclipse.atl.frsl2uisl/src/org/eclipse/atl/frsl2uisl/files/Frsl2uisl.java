...
/**
 * Entry point of the 'Frsl2uisl' transformation module.
 */
public class Frsl2uisl {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 3) {
				...
				Frsl2uisl runner = new Frsl2uisl();
				runner.loadModels(args[0], args[1]);
				runner.doFrsl2uisl(new NullProgressMonitor());
	 ...
	 * @generated
	 */
	public Frsl2uisl() throws IOException {
		properties = new Properties();
		properties.load(getFileURL("Frsl2uisl.properties").openStream());
		// EPackage.Registry.INSTANCE.put(getMetamodelUri("PIVOT"), org.eclipse.ocl.pivot.PivotPackage.eINSTANCE);
	...
	public void loadModels(String inModelPath, String in2ModelPath) throws ATLCoreException {
		...
		injector.inject(frslMetamodel, getMetamodelUri("FRSL"));
	 	IReferenceModel uislMetamodel = factory.newReferenceModel();
		injector.inject(uislMetamodel, getMetamodelUri("UISL"));
		...
		this.outModel = factory.newModel(uislMetamodel);
	}

	public void loadModels(InputStream inModelPath, String in2ModelPath) throws ATLCoreException {
	 ...
	 * @generated
	 */
	public Object doFrsl2uisl(IProgressMonitor monitor) throws ATLCoreException, IOException, ATLExecutionException {
		ILauncher launcher = new EMFVMLauncher();
		Map<String, Object> launcherOptions = getOptions();
		launcher.initialize(launcherOptions);
		launcher.addInModel(inModel, "IN", "FRSL");
		launcher.addInModel(in2Model, "IN2", "PIVOT");
		launcher.addOutModel(outModel, "OUT", "UISL");
	...
	protected InputStream[] getModulesList() throws IOException {
		...
		String modulesList = properties.getProperty("Frsl2uisl.modules");
		if (modulesList != null) {
	...
	protected String getMetamodelUri(String metamodelName) {
		return properties.getProperty("Frsl2uisl.metamodels." + metamodelName);
	}
	...
	protected InputStream getLibraryAsStream(String libraryName) throws IOException {
		return getFileURL(properties.getProperty("Frsl2uisl.libraries." + libraryName)).openStream();
	}
	...
	protected Map<String, Object> getOptions() {
		...
		for (Entry<Object, Object> entry : properties.entrySet()) {
			if (entry.getKey().toString().startsWith("Frsl2uisl.options.")) {
				options.put(entry.getKey().toString().replaceFirst("Frsl2uisl.options.", ""), 
	...
	protected static URL getFileURL(String fileName) throws IOException {
		final URL fileURL;
		if (isEclipseRunning()) {
			URL resourceURL = Frsl2uisl.class.getResource(fileName);
			if (resourceURL != null) {
			...
			fileURL = Frsl2uisl.class.getResource(fileName);
		}
		if (fileURL == null) {
